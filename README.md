...
### Windows Executable
A Windows Standalone executable is now incuded in the dist folder, copy onto your PC somewhere suitable and double-click it. <a href="https://github.com/kazzle101/midiObsWS/blob/main/dist/midiObsWS.exe" target="_blank">DOWNLOAD HERE</a>
